...
app.post('/send-thank-you', async (req, res) => {
  try {
    ...
    const mailOptions = {
      from: 'ersshekhar05@gmail.com',
      to: email,
      subject: 'Thank You for Contacting Azone Institute of Technology',
      text: `Thank you ${name || 'Valued Visitor'} for reaching out to Azone Institute of Technology. We appreciate your time and will get back to you soon!`,
      html: `
      <!DOCTYPE html>
      <html>
      <head>
          ...
          <title>Thank You from Azone Institute of Technology</title>
          <style>
              body {
      ...
      <body>
          <div class="header">
              <div class="logo">Azone Institute of Technology</div>
          </div>
          
          <div class="content">
              <h1>Thank You, ${name || 'Valued Visitor'}!</h1>
              
              <p>We're thrilled that you've taken the first step toward your technological journey with Azone Institute of Technology. Your inquiry is important to us, and we appreciate you considering us for your educational needs.</p>
              
              <div class="highlight">
                  <p><strong>What happens next?</strong><br>
                  Our team will review your message and get back to you within 24-48 hours. In the meantime, feel free to explore more about our programs and offerings.</p>
              </div>
              
              <center>
                  <a href="https://www.azoneinstitute.com" class="button">Visit Our Website</a>
              </center>
              
              <p>At Azone, we're committed to providing cutting-edge technology education that prepares you for the future. We look forward to speaking with you soon!</p>
              
              <p>Warm regards,</p>
              <p><strong>The Azone Team</strong></p>
              
              <div class="social-icons">
                  <a href="https://facebook.com/azoneinstitute">Facebook</a> | 
                  <a href="https://twitter.com/azoneinstitute">Twitter</a> | 
                  <a href="https://linkedin.com/company/azoneinstitute">LinkedIn</a>
              </div>
          </div>
          
          <div class="footer">
              <p>Azone Institute of Technology &copy; ${new Date().getFullYear()}</p>
